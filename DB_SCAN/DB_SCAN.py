...
def DBscan(Dic, Eps, MinPts):
    ...
    for index_i in range(len(value_k)):
        if(index_i > 6):
            #if((value_k[index_i - 4] - value_k[index_i - 5])**2 <= 1 and 
            #   (value_k[index_i - 2] - value_k[index_i - 3])**2 <= 1 and 
            #   (value_k[index_i - 3] - value_k[index_i - 4])**2 <= 1 and 
            #   value_k[index_i - 1] != value_k[index_i - 2]):
            #if(value_k[index_i - 5] == value_k[index_i - 6] and
            #   value_k[index_i - 4] == value_k[index_i - 5] and
